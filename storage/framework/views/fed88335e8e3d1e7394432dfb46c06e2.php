    ...
    <div class="container py-5">
        <div>
            <div class="d-flex justify-content-between mb-3 alert alert-primary">
                <h5 class="fw-bold text-uppercase text-primary"> player <?php echo e($players); ?></h5>
                ...
                <a class="h5 fw-bold d-flex justify-content-center align-items-center text-primary"
                    href="<?php echo e(route('get.add-player')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Downloads\cricket-scorecard\resources\views/pages/players/playerList.blade.php ENDPATH**/ ?>