<div class="col-md-6">
    <div class="box p-3" style="min-height: 1500px">
            ...
            <div class=" d-flex justify-content-between align-items-end">
                <div style="font-size:14px">
                    <h6 style="font-size:14px" class="fw-bold text-uppercase">
                        <span class="text-primary"><?php echo e(substr($firstBowlingTeamName, 0, 3)); ?></span>
                        <?php echo e($innings2BattingScore['totalRuns']); ?>/<?php echo e($innings2BattingScore['totalWickets']); ?>

                    </h6>
                    <h6 style="font-size:14px" class="fw-bold"><span class="text-primary">Over
                        </span><?php echo e($innings2BattingScore['totalOvers']); ?>
                ...
                <div>
                    <h6 style="font-size:14px" class="fw-bold">
                        <span class="text-primary">RR</span> <?php echo e($innings2BattingScore['runRate']); ?>

                    </h6>
                    <h6 style="font-size:14px" class="fw-bold"><span class="text-primary">Extra
                        </span><?php echo e($innings2BattingScore['totalExtraRuns']); ?>
                ...
                <div>
                    <h6 style="font-size:14px" class="fw-bold "><span class="text-primary">Total
                            4S</span>
                        <?php echo e($innings2BattingScore['totalFours']); ?></h6>
                    <h6 style="font-size:14px" class="fw-bold "><span class="text-primary">Total 6S
                        </span><?php echo e($innings2BattingScore['totalSixes']); ?></h6>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <h6 style="font-size:14px" class="fw-bold"> Highest Run <span
                            class="text-primary"><?php echo e($secondHighestRunScorer['batsmanName']); ?></span> </h6>
                    <h6 style="font-size:14px" class="fw-bold">(R <?php echo e($secondHighestRunScorer['runs']); ?>,
                        B
                        <?php echo e($secondHighestRunScorer['balls']); ?>,
                        SR <?php echo e($secondHighestRunScorer['strike_rate']); ?> )</h6>
                    <h6 style="font-size:14px" class="fw-bold">(4S
                        <?php echo e($secondHighestRunScorer['fours']); ?>,
                        6S
                        <?php echo e($secondHighestRunScorer['sixes']); ?>) </h6>
                </div>
                <div class="col-md-6">
                    <h6 style="font-size:14px" class="fw-bold">Most ECO Bowler
                            <span class="text-primary"><?php echo e($secondMostEconomicalBowler['bowlerName']); ?></span>
                    </h6>
                    <h6 style="font-size:14px" class="fw-bold">(R
                        <?php echo e($secondMostEconomicalBowler['runs']); ?>, O
                        <?php echo e($secondMostEconomicalBowler['totalOvers']); ?>, ECO
                        <?php echo e($secondMostEconomicalBowler['economyRate']); ?>)</h6>
                    <h6 style="font-size:14px" class="fw-bold">(EXT
                        <?php echo e($secondMostEconomicalBowler['totalExtra']); ?>, NB
                        <?php echo e($secondMostEconomicalBowler['totalNoCount']); ?>, WD
                        <?php echo e($secondMostEconomicalBowler['totalWideCount']); ?>)</h6>
                </div>
            </div>
        </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php $__currentLoopData = $secondTeamIndividualScore; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $score): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php $__currentLoopData = $secondBowlingIndividualScore; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $score): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($loop->index + 1); ?></td>
        ...
        <div class="score-line my-3">
            ...
            <div class="d-flex flex-wrap">
                ...
                <?php $__currentLoopData = $secondTeamScoreLine; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $score): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH E:\Downloads\cricket-scorecard\resources\views/components/summary/secondInnings.blade.php ENDPATH**/ ?>