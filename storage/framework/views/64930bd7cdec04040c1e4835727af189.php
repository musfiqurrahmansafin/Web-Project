<div class="col-md-7">
    <div class="box p-3">
        ...
        <div id="firstInnings">
            <div class="row">
                <div class="col-md-6">
                    <?php if($firstBattingSquad && count($firstBattingSquad) > 0): ?>
                        <h6 class="fw-bold btn btn-primary w-100 btn-sm">
                            <?php echo e($firstBattingSquad[0]['team_name']); ?> Batting XI
                        </h6>
                        <?php $__currentLoopData = $firstBattingSquad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $player): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="d-flex">
                                <small class="me-2 fw-bold"><?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?></small>
                                <div class="form-check">
                                    <input class="form-check-input batsman-checkbox" type="checkbox" name="batsman_id[]"
                                           value="<?php echo e($player['player_id']); ?>"
                                           <?php if(in_array($player['player_id'], old('batsman_id', [])) || in_array($player['player_id'], $outBatsmanList)): ?> disabled
                                           <?php endif; ?>
                ...
                <div class="col-md-6">
                    <?php if($firstBowlingSquad && count($firstBowlingSquad) > 0): ?>
                        <h6 class="fw-bold btn btn-primary w-100 btn-sm">
                            <?php echo e($firstBowlingSquad[0]['team_name']); ?> Bowling XI
                        </h6>
                        <?php $__currentLoopData = $firstBowlingSquad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $player): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="d-flex">
                                <small class="me-2 fw-bold"><?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?></small>
                                <div class="form-check">
...
<?php /**PATH E:\Downloads\cricket-scorecard\resources\views/components/squad/firstInnings.blade.php ENDPATH**/ ?>